...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_12)
#define OLED_SCLK_Set() GPIO_SetBits(GPIOA,GPIO_Pin_12)//SCL

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_11)//DIN
