...
//   ST7789_DC_Clr();
//   uint8_t res;
//   HAL_SPI_TransmitReceive(&ST7789_SPI_PORT, &cmd, &res, sizeof(cmd),
//                           HAL_MAX_DELAY);
//   ST7789_UnSelect();
// }
...
// #else
//     HAL_SPI_TransmitReceive(&ST7789_SPI_PORT, buff, &res, chunk_size,
//                             HAL_MAX_DELAY);
// #endif
//     buff += chunk_size;
...
//   ST7789_Select();
//   ST7789_DC_Set();
//   HAL_SPI_TransmitReceive(&ST7789_SPI_PORT, &data, &res, sizeof(data),
//                           HAL_MAX_DELAY);
//   ST7789_UnSelect();
// }
