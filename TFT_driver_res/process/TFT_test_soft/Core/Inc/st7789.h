...
// void ST7789_WriteString(uint16_t x, uint16_t y, const char *str, FontDef
// font,
//                         uint16_t color, uint16_t bgcolor);

// /* Extented Graphical functions. */
// void ST7789_DrawFilledRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t
// h,
//                                 uint16_t color);
...
//                                uint16_t color);
// void ST7789_DrawFilledCircle(int16_t x0, int16_t y0, int16_t r, uint16_t
// color);
